...
//				game.addCreature(new Herbivore(25,25));
//				game.addCreature(new Plant(26,25));
//				game.addCreature(new Plant(24,25));
//				game.addCreature(new Plant(25,24));
//				game.addCreature(new Plant(25,26));
